...
<body>
    ...
    <main class="min-h-[90vh] mx-auto p-4 flex justify-center items-center">
        <section class="max-w-[600px] min-h-[630px] pt-20 pb-6 px-4 bg-light-gray rounded-lg min-[500px]:px-10 min-[500px]:pt-20">
            <h1 class="mb-10 uppercase font-bold text-3xl text-center">Log in as a user</h1>
            ...
            <form action="user-login-processing.php" method="post">
                ...
                <div class="mb-10 flex flex-col gap-4 items-center justify-center min-[500px]:flex-row">
                    <a href="index.php" class="w-[230px] p-button rounded-lg bg-black text-center uppercase text-white hover:bg-[#4a4a4a]"><p>Go back</p></a>
                    <input type="submit" value="Login" class="btn-blue w-[230px] tracking-widest uppercase"/>	
                </div>
            </form>
            <p class="tracking-wider">Don't have an account? Click <a href="user-registration.php" class="border-b-[3px] border-solid border-accent hover:text-hover-gray hover:border-accent-light">here</a> to create an account</p>
        </section>
    </main>
